    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_at', models.DateTimeField(auto_now_add=True)),
                ('form_user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='from_user', to=settings.AUTH_USER_MODEL)),
                ('from_account', models.ManyToManyField(related_name='from_account', to='walet.CashAccount')),
